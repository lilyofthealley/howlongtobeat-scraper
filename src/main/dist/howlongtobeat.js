...
class HowLongToBeatEntry {
    ...
    additionalContent;
    mainGame;
    constructor(id, title, description, imageUrl, platforms, genres, developers, publishers, released, timeLabels, gameplayMain, gameplayMainExtra, gameplayCompletionist, gameplayAllStyles, additionalContent, mainGame) {
        this.id = id;
        this.title = title;
